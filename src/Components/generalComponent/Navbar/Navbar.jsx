...
export default function Navbar() {
  return (
    <>
      <nav class="px-[100px] py-[4px] w-full  h-[72px]">
        <div class="container mx-auto flex items-center justify-between px-1 py-1">
          {/* logo section */}
          ...
          <div class="hidden md:flex space-x-6">
            <a
              href="#explore"
              class="block text-[#1b1b1e] text-[1rem] tracking-[0.5px] font-family font-medium hover:text-black"
            >
              Explore
            </a>
            <a
          ...
          <div class="space-x-4 flex">
            ...
            <button class="hidden md:inline-block bg-custom-gradient text-[#ffffff] text-xs tracking-[0.5px] font-family font-medium w-[89px] h-[48px] px-4 py-2 rounded-[400px]  text-center">
              Sign Up
            </button>
          </div>
        </div>
